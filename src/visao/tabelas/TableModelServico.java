...
public class TableModelServico  extends AbstractTableModel {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 1: // Terceira coluna é a data de cadastro.
			return servico.getNome().toUpperCase(getDefault());
		default:
			// Se o índice da coluna não for válido, lança um
			// IndexOutOfBoundsException (Exceção de índice fora dos limites).
			// Não foi necessário verificar se o índice da linha é inválido,
	 ...
	 * até porque este table model não é editável. */
  	public void setValueAt(Servico aValue, int rowIndex) {
	...
	public void addLista(List<Servico> obj) {
