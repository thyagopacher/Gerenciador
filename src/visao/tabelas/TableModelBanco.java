...
public class TableModelBanco  extends AbstractTableModel {
	...
	private final List<Banco> linhas;
	/* Array de Strings com o nome das colunas. */
	private String[] colunas;

	/* Cria um BancoTableModel vazio. */
	public TableModelBanco() {
		linhas        = new ArrayList<>(100);
                this.colunas  = new String[] {"Código", "Nome"};
	}

	/* Cria um BancoTableModel carregado com
	 * a lista de sócios especificada. */
	public TableModelBanco(List<Banco> obj) {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		Banco banco = linhas.get(rowIndex);
		...
		case 1: 
			return banco.getNome().toUpperCase(getDefault());
		default:
			// Se o índice da coluna não for válido, lança um
			// IndexOutOfBoundsException (Exceção de índice fora dos limites).
			// Não foi necessário verificar se o índice da linha é inválido,
	...
	public void addLista(List<Banco> obj) {
