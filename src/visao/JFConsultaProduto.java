 ...
 * @author Thyago
 */
public class JFConsultaProduto extends JDialog {
    ...
    /**
     * Creates new form JFConsultaProduto
     */
    public JFConsultaProduto() {
        initComponents();
    }

    public JFConsultaProduto(Conexao cx) {
        initComponents();
        tabela.setModel(tm);
        this.cx = cx;
    ...
    private void initComponents() {
        ...
        bperfil.setToolTipText("Retorna informações do produto");
    ...
    private void tcodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tcodigoKeyPressed
        if(evt.getKeyCode() == 10){
            produto = prn.procurarObjeto("codigo", (tcodigo.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            getLogger(JFConsultaProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
    ...
    public boolean alterarDadosProduto(){  
