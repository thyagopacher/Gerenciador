...
public interface CountrySoap {
    ...
    @RequestWrapper(localName = "GetCountryByCountryCode", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCountryByCountryCode")
    @ResponseWrapper(localName = "GetCountryByCountryCodeResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCountryByCountryCodeResponse")
    ...
    @RequestWrapper(localName = "GetISD", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetISD")
    @ResponseWrapper(localName = "GetISDResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetISDResponse")
    ...
    @RequestWrapper(localName = "GetCountries", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCountries")
    @ResponseWrapper(localName = "GetCountriesResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCountriesResponse")
    ...
    @RequestWrapper(localName = "GetCurrencyCodeByCurrencyName", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCurrencyCodeByCurrencyName")
    @ResponseWrapper(localName = "GetCurrencyCodeByCurrencyNameResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCurrencyCodeByCurrencyNameResponse")
    ...
    @RequestWrapper(localName = "GetISOCountryCodeByCountyName", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetISOCountryCodeByCountyName")
    @ResponseWrapper(localName = "GetISOCountryCodeByCountyNameResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetISOCountryCodeByCountyNameResponse")
    ...
    @RequestWrapper(localName = "GetCurrencyCode", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCurrencyCode")
    @ResponseWrapper(localName = "GetCurrencyCodeResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCurrencyCodeResponse")
    ...
    @RequestWrapper(localName = "GetCountryByCurrencyCode", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCountryByCurrencyCode")
    @ResponseWrapper(localName = "GetCountryByCurrencyCodeResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCountryByCurrencyCodeResponse")
    ...
    @RequestWrapper(localName = "GetCurrencies", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCurrencies")
    @ResponseWrapper(localName = "GetCurrenciesResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCurrenciesResponse")
    ...
    @RequestWrapper(localName = "GetCurrencyByCountry", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCurrencyByCountry")
    @ResponseWrapper(localName = "GetCurrencyByCountryResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetCurrencyByCountryResponse")
    ...
    @RequestWrapper(localName = "GetGMTbyCountry", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetGMTbyCountry")
    @ResponseWrapper(localName = "GetGMTbyCountryResponse", targetNamespace = "http://www.webserviceX.NET", className = "paises.GetGMTbyCountryResponse")
